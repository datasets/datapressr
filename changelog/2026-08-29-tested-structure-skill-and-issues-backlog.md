...
Every dataset now also needs a recorded license and source before it's more than a stub — see [AGENTS.md](https://github.com/datasets/datapressr/blob/main/AGENTS.md) for the full set of conventions and [the `structure` skill](https://github.com/datasets/datapressr/blob/main/.claude/skills/structure/SKILL.md) for the playbook.
