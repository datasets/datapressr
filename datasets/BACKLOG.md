...
**This file no longer tracks active candidates.** Beads (`bd ready`) tracks actionable work; [GitHub issues](https://github.com/datasets/datapressr/issues) retain lightweight captures and historical discussion. Start with [NEXT.md](../NEXT.md). The entries below preserve what was sourced from the commons tracker and published; they are history, not a live backlog.
